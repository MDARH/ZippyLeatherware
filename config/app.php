...
return [
    ...
    */
    ...
    'name' => env('APP_NAME', 'ZippyLeatherware'),
    ...
    */
    ...
    'url' => env('APP_URL', 'http://zippyleatherware.com/'),
    ...
    */
    ...
    'providers' => [
         ...
         */
        ZippyLeatherware\Providers\AppServiceProvider::class,
        ZippyLeatherware\Providers\AuthServiceProvider::class,
        // ZippyLeatherware\Providers\BroadcastServiceProvider::class,
        ZippyLeatherware\Providers\EventServiceProvider::class,
        ZippyLeatherware\Providers\RouteServiceProvider::class,
